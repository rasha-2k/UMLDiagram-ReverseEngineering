...
public class RoomPanel extends javax.swing.JDialog {
    ...
    private void roomObjectCreation() {
        ...
        room = new Room(null);
        room.setRoomNo(tf_roomNo.getText());
        room.setBedNumber(Integer.parseInt(tf_beds.getText()));
        ...
        room.getRoomClass().setRoomType(combo_roomType.getSelectedItem().toString());

        try {
            room.setRoomId(Integer.parseInt(tf_roomID.getText()));
        } catch (Exception ex) {
            room.setRoomId(-1);
        }
    }
